	...
	<div class="border_top_cart">
		<div class="container payment-con">
			<div class="order-info">
				<div class="msg">
					<h3>餐馆名称：朴园大酒店</h3>
					<p>餐品名称：${ONLY.meal_name }</p>
					<p class="post-date">订单状态：商家未接单</p>
				</div>
				<div class="info">
					<p>
						金额：<span class="pay-total">${ONLY.indent_price }元</span>
					</p>
					<p>订单备注：${ONLY.indent_txt }</p>
					<p>订单时间：${ONLY.indent_time }</p>
					<p>
						详情：${ONLY.user_name } <span class="line">/</span> ${ONLY.address_tel } <span class="line">/</span>
						${ONLY.address_name } <span class="line">/</span>
					</p>
				</div>
				<div class="icon-box">
					<img src="${ONLY.meal_img }" width="100%" height="100%">
				</div>
			</div>
			<div>
